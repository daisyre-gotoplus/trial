...
<?php include "libs/accordion-menu-ink.php";?>
<div class="container">
  <div class="row">
    ...
    <div class="col-md-9 col-sm-6 col-xs-12 padding-products">
      <div class="row">
          <div class="col-md-4 col-sm-12 col-xs-12 card-style filterDiv epson 1500-5000">
            <div class="card">
              <img class="card-img-top" src="img/toner-epson.png" alt="Card image cap">
              <div class="card-body">
                <hr>
                <h4 class="card-title"><a>Epson T664 Original Inks(Set of 4 colors)</a></h4>
                <p class="card-text red">&#8369; 1,500.00</p><br>
                <a href="product-profile-ink-1.php" class="btn btn-primary">Read More</a>
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 col-xs-12 card-style filterDiv epson 1500-5000">
            <div class="card">
              <img class="card-img-top" src="img/toner-epson-1.png" alt="Card image cap">
              <div class="card-body">
                <hr>
                <h4 class="card-title"><a>Epson T664 Original Inks(Set of 4 colors)</a></h4>
                <p class="card-text red">&#8369; 1,500.00</p><br>
                <a href="product-profile-ink-2.php" class="btn btn-primary">Read More</a>
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 col-xs-12 card-style filterDiv epson 1500-5000">
            <div class="card">
              <img class="card-img-top" src="img/toner-epson-2.png" alt="Card image cap">
              <div class="card-body">
                <hr>
                <h4 class="card-title"><a>Epson T664 Original Inks(Set of 4 colors)</a></h4>
                <p class="card-text red">&#8369; 1,500.00</p><br>
                <a href="product-profile-ink-3.php" class="btn btn-primary">Read More</a>
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 col-xs-12 card-style filterDiv canon 1500-5000">
            <div class="card">
              <img class="card-img-top" src="img/toner-canon.png" alt="Card image cap">
              <div class="card-body">
                <hr>
                <h4 class="card-title"><a>Canon Geniune PIXMA Ink GI-790</a></h4>
                <p class="card-text red">&#8369; 1,895.00</p><br>
                <a href="product-profile-ink-4.php" class="btn btn-primary">Read More</a>
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 col-xs-12 card-style filterDiv canon 900-1500">
            <div class="card">
              <img class="card-img-top" src="img/toner-canon-1.png" alt="Card image cap">
              <div class="card-body">
                <hr>
                <h4 class="card-title"><a>Canon 746 CL-746 Colour Inkjet</a></h4>
                <p class="card-text red">&#8369; 1,169.00</p><br>
                <a href="product-profile-ink-5.php" class="btn btn-primary">Read More</a>
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 col-xs-12 card-style filterDiv canon 1500-5000">
            <div class="card">
              <img class="card-img-top" src="img/toner-canon-2.png" alt="Card image cap">
              <div class="card-body">
                <hr>
                <h4 class="card-title"><a>Canon PGI-750BK / CLI-751 </a></h4>
                <p class="card-text red">&#8369; 2,150.00</p><br>
                <a href="product-profile-ink-6.php" class="btn btn-primary">Read More</a>
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 col-xs-12 card-style filterDiv brother 500-899">
            <div class="card">
              <img class="card-img-top" src="img/toner-brother.png" alt="Card image cap">
              <div class="card-body">
                <hr>
                <h4 class="card-title"><a>Brother Ink (Original) for DCP-T300</a></h4>
                <p class="card-text red">&#8369; 895.00</p><br>
                <a href="product-profile-ink-7.php" class="btn btn-primary">Read More</a>
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 col-xs-12 card-style filterDiv brother 1500-5000">
            <div class="card">
              <img class="card-img-top" src="img/toner-brother-1.png" alt="Card image cap">
              <div class="card-body">
                <hr>
                <h4 class="card-title"><a>Brother LC535XL-Y / LC535XL-M</a></h4>
                <p class="card-text red">&#8369; 1,895.00</p><br>
                <a href="product-profile-ink-8.php" class="btn btn-primary">Read More</a>
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 col-xs-12 card-style filterDiv brother 1500-5000">
            <div class="card">
              <img class="card-img-top" src="img/toner-brother-2.png" alt="Card image cap">
              <div class="card-body">
                <hr>
                <h4 class="card-title"><a>Brother LC535XL-Y / LC535XL-M</a></h4>
                <p class="card-text red">&#8369; 1,895.00</p><br>
                <a href="product-profile-ink-9.php" class="btn btn-primary">Read More</a>
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 col-xs-12 card-style filterDiv hp 500-899">
            <div class="card">
              <img class="card-img-top" src="img/toner-hp.png" alt="Card image cap">
              <div class="card-body">
                <hr>
                <h4 class="card-title"><a>HP F6V27AA 680 Original Ink (Black)</a></h4>
                <p class="card-text red">&#8369; 750.00</p><br>
                <a href="product-profile-ink-10.php" class="btn btn-primary">Read More</a>
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 col-xs-12 card-style filterDiv hp 1500-5000">
            <div class="card">
              <img class="card-img-top" src="img/toner-hp-1.png" alt="Card image cap">
              <div class="card-body">
                <hr>
                <h4 class="card-title"><a>HP 63 Original Ink Advantage Combo</a></h4>
                <p class="card-text red">&#8369; 1,895.00</p><br>
                <a href="product-profile-ink-11.php" class="btn btn-primary">Read More</a>
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 col-xs-12 card-style filterDiv hp 1500-5000">
            <div class="card">
              <img class="card-img-top" src="img/toner-hp-2.png" alt="Card image cap">
              <div class="card-body">
                <hr>
                <h4 class="card-title"><a>HP 63 Original Ink Advantage Combo</a></h4>
                <p class="card-text red">&#8369; 1,895.00</p><br>
                <a href="product-profile-ink-12.php" class="btn btn-primary">Read More</a>
              </div>
            </div>
          </div>
      </div>
